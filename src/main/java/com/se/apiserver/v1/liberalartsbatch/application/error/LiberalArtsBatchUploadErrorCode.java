...
public enum LiberalArtsBatchUploadErrorCode implements ErrorCode {
  ...
  INVALID_PERIOD_DATA(400, "LABFUE08", "엑셀 내 유효하지 않은 교시 존재"),
  INVALID_DIVISION_NUMBER_DATA(400, "LABFUE09", "엑셀 내 유효하지 않은 분반 정보 존재"),
  INVALID_LECTURE_ROOM_DATA(400, "LABFUE10", "엑셀 내 유효하지 않은 강의실 정보 존재");
