...
public class TeacherApiController {
  ...
  public SuccessResponse<Long> createTeacher(@RequestBody @Validated TeacherCreateDto.Request request){
  ...
  @ResponseStatus(value = HttpStatus.OK)
  public SuccessResponse<PageImpl> read(@Validated PageRequest pageRequest){
