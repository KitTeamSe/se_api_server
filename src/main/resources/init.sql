...
INSERT INTO ACCOUNT (ACCOUNT_ID, EMAIL, ID_STRING, INFORMATION_OPEN_AGREE, STUDENT_ID, NAME, NICKNAME, PASSWORD, PHONE_NUMBER, TYPE)
VALUES (1, 'user@user.com', 'user', 'AGREE', '00000000', 'user', 'user', '{bcrypt}$2a$10$kQ7ZjT0yfgCDfD2pPRPdCu81ZPee.GCeuwniYdDS0dmr7889MGYZO'
, '00000000000', 'STUDENT');
