...
public class AuthorityTest {
    @Autowired private AuthorityJpaRepository authorityJpaRepository;
    @Autowired private AccountJpaRepository accountJpaRepository;
    @Autowired private AuthorityGroupJpaRepository authorityGroupJpaRepository;
    @Autowired private AuthorityGroupAccountMappingJpaRepository authorityGroupAccountMappingJpaRepository;
    @Autowired private AuthorityGroupAuthorityMappingJpaRepository authorityGroupAuthorityMappingJpaRepository;
    ...
    void test(){
        ...
        authorityList.stream().forEach(a -> System.out.println(a.getNameEng()));
    }
}
