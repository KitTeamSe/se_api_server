...
class AccountVerifyServiceTest {
    ...
    void 인증메일_발송요청_이메일이용_성공() {
        ...
        createData();
        //when
        boolean res = accountVerifyService.sendVerifyRequestEmailByEmail("djh20@naver.com");
        //then
    ...
    void 인증메일_발송요청_아이디이용_성공() {
        ...
        createData();
        //when
        boolean res = accountVerifyService.sendVerifyRequestEmailByAccountId("test");
        //then
        Assertions.assertThat(res).isEqualTo(true);
    }
    ...
    void 인증메일_발송요청_아이디없음_실패() {
        ...
        Assertions.assertThatThrownBy(() -> {
            accountVerifyService.sendVerifyRequestEmailByAccountId("test2");
