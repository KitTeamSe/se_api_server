...
public class AccountReadUseCaseTest {
    ...
    @Autowired
    AccountReadUseCase accountReadUseCase;
    @Autowired
    ...
    public void 로그인_본인아님_관리자아님_조회_미포함정보() {
        ...
        //when
        AccountReadDto.Response dto = accountReadUseCase.read("user");
    ...
    void 회원_검색_페이지() {
        //given
        //when
        PageImpl search = accountReadUseCase.search(AccountReadDto.SearchRequest.builder()
