...
class AttachDeleteServiceTest {
    ...
    void 첨부파일_삭제_성공() {
        ...
        attachDeleteService.delete(attachNoParent.getAttachId());
        attachDeleteService.delete(attachPost.getAttachId());
        attachDeleteService.delete(attachReply.getAttachId());
        //then
    ...
    void 첨부파일_미존재_실패() {
        ...
        Assertions.assertThatThrownBy(() -> {
            attachDeleteService.delete(4444L);
