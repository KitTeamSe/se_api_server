...
class AuthorityGroupCreateServiceTest {
    ...
    @Autowired
    AuthorityGroupCreateService authorityGroupCreateService;
    ...
    void 권한그룹_생성_성공() {
        createData();
        //given
        AuthorityGroupReadDto.Response response = authorityGroupCreateService.create(AuthorityGroupCreateDto.Request.builder()
                .name("권한그룹")
                .description("권한그룹 설명")
                .build());
        //when
    ...
    void 권한그룹_이름중복_실패() {
        ...
        Assertions.assertThatThrownBy(() -> {
            authorityGroupCreateService.create(AuthorityGroupCreateDto.Request.builder()
                    .name("권한그룹")
                    .description("권한그룹 설명")
                    .build());
