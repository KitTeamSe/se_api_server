...
class AuthorityGroupAccountMappingCreateServiceTest {
    @Autowired
    AuthorityGroupAccountMappingCreateService authorityGroupAccountMappingCreateService;
    @Autowired
    ...
    void 권한그룹_사용자_생성_성공() {
        ...
        initData();
        //when
        Long id = authorityGroupAccountMappingCreateService.create(AuthorityGroupAccountMappingCreateDto.Request.builder()
    ...
    void 권한그룹_사용자_생성_중복_실패() {
        ...
        Assertions.assertThatThrownBy(() -> {
            authorityGroupAccountMappingCreateService.create(AuthorityGroupAccountMappingCreateDto.Request.builder()
                    .accountId(account.getAccountId())
                    .groupId(authorityGroup.getAuthorityGroupId())
                    .build());
