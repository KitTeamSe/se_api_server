...
class AuthorityGroupAccountMappingReadServiceTest {
    @Autowired
    AuthorityGroupAccountMappingReadService authorityGroupAccountMappingReadService;
    @Autowired
    ...
    void 권한그룹_사용자_조회_성공() {
        ...
        //when
        AuthorityGroupAccountMappingReadDto.Response read = authorityGroupAccountMappingReadService.read(authorityGroupAccountMapping.getAuthorityGroupAccountMappingId());
        //then
    ...
    void 권한그룹_사용자_목록_조회_성공() {
        ...
        //when
        PageImpl page = authorityGroupAccountMappingReadService.readAll(PageRequest.builder()
