...
class AuthorityGroupAuthorityMappingCreateServiceTest {
    @Autowired
    AuthorityGroupAuthorityMappingCreateService authorityGroupAuthorityMappingCreateService;
    @Autowired
    ...
    void 등록_성공() {
        ...
        initData();
        //when
        Long id = authorityGroupAuthorityMappingCreateService.create(AuthorityGroupAuthorityMappingCreateDto.Request.builder()
