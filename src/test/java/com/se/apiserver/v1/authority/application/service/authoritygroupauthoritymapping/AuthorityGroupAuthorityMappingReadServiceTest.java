...
class AuthorityGroupAuthorityMappingReadServiceTest {
    @Autowired
    AuthorityGroupAuthorityMappingReadService authorityGroupAuthorityMappingReadService;
    @Autowired
    ...
    void 조회_성공() {
        ...
        initData();
        //when
        AuthorityGroupAuthorityMappingReadDto.Response read = authorityGroupAuthorityMappingReadService
    ...
    void 목록_조회_성공() {
        ...
        initData();
        //when
        PageImpl read = authorityGroupAuthorityMappingReadService
