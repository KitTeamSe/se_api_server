...
@SpringBootTest
@Transactional
public class PeriodCreateUseCaseTest {
  
  @Autowired
  PeriodJpaRepository periodJpaRepository;
  
  @Autowired
  PeriodCreateUseCase periodCreateUseCase;
  ...
  void 교시_생성_성공(){
    ...
    // When
    Long id = periodCreateUseCase.create(request);
  ...
  void 교시_생성_시작시간_종료시간_교차_실패(){
    ...
    Assertions.assertThatThrownBy(() ->{
      periodCreateUseCase.create(request);
