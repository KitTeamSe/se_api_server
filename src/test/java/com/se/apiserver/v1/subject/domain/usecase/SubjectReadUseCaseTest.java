...
public class SubjectReadUseCaseTest {
  ...
  void 교과_조회_성공(){
    ...
    // When
    SubjectReadDto.Response response = subjectReadUseCase.read(id);
  ...
  void 교과_전체_조회_성공(){
    ...
    // When
    PageImpl responses = subjectReadUseCase.readAll(PageRequest.builder()
        .size(100)
