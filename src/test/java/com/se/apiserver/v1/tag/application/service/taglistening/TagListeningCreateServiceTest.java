...
@SpringBootTest
@Transactional
class TagListeningCreateServiceTest {
    @Autowired
    ...
    void 수신태그_등록_본인_성공() {
        ...
        //when
        Long id = tagListeningCreateService.create(TagListeningCreateDto.Request.builder()
                .tagId(tag1.getTagId())
                .build());
    ...
    void 수신태그_중복_실패() {
        ...
        Assertions.assertThatThrownBy(() -> {
            tagListeningCreateService.create(TagListeningCreateDto.Request.builder()
                    .tagId(tag1.getTagId())
                    .build());
